...
def get_build_graph_of_ontology_entity(entity_uri,strType):
    ...
    return out
#14rd : Run planning
def run_planning_engine(path_to_clingo,path_to_main_base,path_to_initial,path_to_goal,number_of_model):
    ...
    p = subprocess.Popen([path_to_clingo, '--outf=2', path_to_main_base,path_to_initial,path_to_goal], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
    out, err = p.communicate()
    #print err
    return out
