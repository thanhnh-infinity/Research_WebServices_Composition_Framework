...
class Interact_Planning_Engine(object):
    ...
    def generateWorkflow(self,**request_data):
        ...
        if sys.version_info[0] < 3:
            ...
            fo = open(os.path.join(self.FULL_PATH_PLANNING_STATES_FOLDER, folder_name ,"initial_state_base.lp"),"w")
        ...
        if sys.version_info[0] < 3:
            ...
            fo = open(os.path.join(self.FULL_PATH_PLANNING_STATES_FOLDER, folder_name ,"goal_state_base.lp"), "w")
        ...
        if sys.version_info[0] < 3:
            ...
            fo = open(os.path.join(self.FULL_PATH_PLANNING_STATES_FOLDER, folder_name ,"composite_preference.lp"),"w")
    ...
    def recomposite(self,**request_data):
        ...
        if sys.version_info[0] < 3:
            ...
            fo = open(os.path.join(self.FULL_PATH_PLANNING_STATES_FOLDER, folder_name ,"re_composite_preference.lp"),"w")
            ...
            if (isOriginalWorkflow and isFailedService):
                ...
                if (engine == 1 or engine == 2 or engine == 3):
                    ...
                    if sys.version_info[0] < 3:
                        ...
                        fo = open(os.path.join(self.FULL_PATH_PLANNING_STATES_FOLDER, folder_name ,"failure_detection.lp"),"w")
                    ...
                    if sys.version_info[0] < 3:
                        ...
                        fo = open(os.path.join(self.FULL_PATH_PLANNING_STATES_FOLDER, folder_name ,"sup_init_generated_resource_failure_detection.lp"),"w")
